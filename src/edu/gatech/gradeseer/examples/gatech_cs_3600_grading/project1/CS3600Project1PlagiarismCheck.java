...
public class CS3600Project1PlagiarismCheck {
	public static void main(String[] args) {
		...
		File file2 = new File("/Users/Haamoon/Desktop/I/University/AI_TA/Project1/Grades/Project 1/BaseFiles/searchAgents.py");
		...
		while(iterator.hasNext())
		{
			...
			List<File> files = as.getSubmissionFiles();
			System.out.println("Adding " + as.getStudent().getName() + " files..");
			detector.addStudentFiles(as.getStudent().getName(), files);
		}
